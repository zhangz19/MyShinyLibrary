...
# An example for mapping spatial data (areal) with CAR model, and some quick estimation 
...
knitr::kable(est, row.names=TRUE, caption = "\\label{tab:t1} Table 1.", digits=3)
